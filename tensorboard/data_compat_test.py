...
class TranslateValueTest(tf.test.TestCase):
  """Tests for `translate_value`.
  ...
  def _value_from_op(self, op):
    summary_pbtxt = tf.Session().run(op)
    summary = tf.Summary()
  ...
  def _assert_noop(self, value):
    ...
    result = data_compat.translate_value(value)
  ...
  def test_histogram(self):
    ...
    new_value = data_compat.translate_value(old_value)
