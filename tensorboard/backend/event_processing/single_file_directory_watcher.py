...
"""Contains the implementation for the SingleFileDirectoryWatcher class."""
...
class SingleFileDirectoryWatcher(directory_watcher.DirectoryWatcher):
  """A SingleFileDirectoryWatcher wraps a loader of a sequence of paths.

  A loader reads a path and produces some kind of values as an iterator. A
  SingleFileDirectoryWatcher takes a directory, a factory for loaders, and
  optionally a path filter and watches all the paths inside that directory.
